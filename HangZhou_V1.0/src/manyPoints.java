...
public class manyPoints extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//System.out.println(request.getParameterValues("position"));
		//String[] posi = request.getParameterValues("position");
		//System.out.println(request.getParameter("posix"));
		//System.out.println(request.getParameter("posiy"));
