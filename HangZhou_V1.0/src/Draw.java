...
public class Draw extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)  
		...
		String sql = " SELECT LEASESTATION ,RETURNSTATION,COUNT(*) AS SUM FROM T_123 where "
				+ "leasestation in(select stationid from G_STATIONORIENT)and returnstation in"
				+ "(select stationid from G_STATIONORIENT) GROUP BY "
				+ "LEASESTATION,RETURNSTATION HAVING COUNT(*)>= ?";
