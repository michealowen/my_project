...
public class new_york extends HttpServlet {
    ...
    //"FROM G_STATIONINFO q INNER JOIN G_STATIONORIENT w ON q.STATIONID=w.STATIONID";
		String sql1= "select distinct START_STATION_ID,START_STATION_NAME,START_STATION_LONGITUDE,START_STATION_LATITUDE from CITI_BIKE_TRIP_DATA";
